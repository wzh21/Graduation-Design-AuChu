...
var t = { 650: (e2, t2, n2) => {
  ...
  e2.exports = function(e3, t2, n2, i2) {
    var r2 = self || window;
    try {
      try {
        var o2;
        try {
          ...
          (o2 = new (r2.BlobBuilder || r2.WebKitBlobBuilder || r2.MozBlobBuilder || r2.MSBlobBuilder)()).append(e3), o2 = o2.getBlob();
        }
        var a2 = r2.URL || r2.webkitURL, s2 = a2.createObjectURL(o2), l2 = new r2[t2](s2, n2);
        return a2.revokeObjectURL(s2), l2;
      } catch (i3) {
        return new r2[t2]("data:application/javascript,".concat(encodeURIComponent(e3)), n2);
      }
    } catch (e4) {
      if (!i2)
        throw Error("Inline worker is not supported");
      return new r2[t2](i2, n2);
    }
  };
}, 290: (e2, t2, n2) => {
  n2.d(t2, { A: () => r2 });
...
function i(e2) {
  ...
  if (void 0 !== r2)
    return r2.exports;
  var o2 = n[e2] = { exports: {} };
  return t[e2](o2, o2.exports, i), o2.exports;
}
i.d = (e2, t2) => {
  for (var n2 in t2)
...
var r = {};
i.d(r, { BS: () => p, u8: () => l, C2: () => $, QB: () => w, bA: () => X, Fn: () => J, qG: () => V, mo: () => q, SA: () => Z, zs: () => U, IR: () => he, QN: () => oe, sP: () => re, mA: () => ae, uT: () => le, Ay: () => de, E5: () => u, UG: () => f, uZ: () => d, uo: () => c, aC: () => Ue, xT: () => Me, PR: () => x, zd: () => Y, Pf: () => h, V9: () => A, Rx: () => Se, Zk: () => T, Nk: () => _, xC: () => C, J0: () => Q });
var o = (a = { AdditiveBlending: () => e.AdditiveBlending, Box3: () => e.Box3, BufferAttribute: () => e.BufferAttribute, BufferGeometry: () => e.BufferGeometry, CanvasTexture: () => e.CanvasTexture, Color: () => e.Color, DataTexture: () => e.DataTexture, EventDispatcher: () => e.EventDispatcher, Frustum: () => e.Frustum, GLSL3: () => e.GLSL3, LessEqualDepth: () => e.LessEqualDepth, LineBasicMaterial: () => e.LineBasicMaterial, LineSegments: () => e.LineSegments, LinearFilter: () => e.LinearFilter, Matrix4: () => e.Matrix4, NearestFilter: () => e.NearestFilter, NoBlending: () => e.NoBlending, Object3D: () => e.Object3D, Points: () => e.Points, RGBAFormat: () => e.RGBAFormat, RawShaderMaterial: () => e.RawShaderMaterial, Scene: () => e.Scene, ShaderMaterial: () => e.ShaderMaterial, Sphere: () => e.Sphere, Texture: () => e.Texture, Uint8BufferAttribute: () => e.Uint8BufferAttribute, Vector2: () => e.Vector2, Vector3: () => e.Vector3, Vector4: () => e.Vector4, WebGLRenderTarget: () => e.WebGLRenderTarget }, s = {}, i.d(s, a), s);
var a;
var s;
var l;
var c;
...
var f;
var u;
var p = class extends o.ShaderMaterial {
  constructor() {
    super(...arguments), this.uniforms = { screenWidth: { type: "f", value: 0 }, screenHeight: { type: "f", value: 0 }, map: { type: "t", value: null } };
  }
};
!function(e2) {
  e2[e2.DISABLED = 0] = "DISABLED", e2[e2.CLIP_OUTSIDE = 1] = "CLIP_OUTSIDE", e2[e2.CLIP_INSIDE = 2] = "CLIP_INSIDE", e2[e2.HIGHLIGHT_INSIDE = 3] = "HIGHLIGHT_INSIDE";
}(l || (l = {})), function(e2) {
  e2[e2.FIXED = 0] = "FIXED", e2[e2.ATTENUATED = 1] = "ATTENUATED", e2[e2.ADAPTIVE = 2] = "ADAPTIVE";
}(c || (c = {})), function(e2) {
  e2[e2.SQUARE = 0] = "SQUARE", e2[e2.CIRCLE = 1] = "CIRCLE", e2[e2.PARABOLOID = 2] = "PARABOLOID";
}(d || (d = {})), function(e2) {
  e2[e2.OCTREE = 0] = "OCTREE", e2[e2.KDTREE = 1] = "KDTREE";
}(h || (h = {})), function(e2) {
  e2[e2.FIXED = 0] = "FIXED", e2[e2.ATTENUATED = 1] = "ATTENUATED";
}(f || (f = {})), function(e2) {
  e2[e2.RGB = 0] = "RGB", e2[e2.COLOR = 1] = "COLOR", e2[e2.DEPTH = 2] = "DEPTH", e2[e2.HEIGHT = 3] = "HEIGHT", e2[e2.ELEVATION = 3] = "ELEVATION", e2[e2.INTENSITY = 4] = "INTENSITY", e2[e2.INTENSITY_GRADIENT = 5] = "INTENSITY_GRADIENT", e2[e2.LOD = 6] = "LOD", e2[e2.LEVEL_OF_DETAIL = 6] = "LEVEL_OF_DETAIL", e2[e2.POINT_INDEX = 7] = "POINT_INDEX", e2[e2.CLASSIFICATION = 8] = "CLASSIFICATION", e2[e2.RETURN_NUMBER = 9] = "RETURN_NUMBER", e2[e2.SOURCE = 10] = "SOURCE", e2[e2.NORMAL = 11] = "NORMAL", e2[e2.PHONG = 12] = "PHONG", e2[e2.RGB_HEIGHT = 13] = "RGB_HEIGHT", e2[e2.COMPOSITE = 50] = "COMPOSITE";
}(u || (u = {}));
var m = "PerspectiveCamera";
var g = new o.Color(0, 0, 0);
var P = new o.Vector4(1, 0, 0, 1);
function b(e2) {
  return parseInt(e2.charAt(e2.length - 1), 10);
}
function v(e2, t2) {
  const n2 = e2.name, i2 = t2.name;
  return n2.length !== i2.length ? n2.length - i2.length : n2 < i2 ? -1 : n2 > i2 ? 1 : 0;
}
var y = { 0: new o.Vector4(0.5, 0.5, 0.5, 1), 1: new o.Vector4(0.5, 0.5, 0.5, 1), 2: new o.Vector4(0.63, 0.32, 0.18, 1), 3: new o.Vector4(0, 1, 0, 1), 4: new o.Vector4(0, 0.8, 0, 1), 5: new o.Vector4(0, 0.6, 0, 1), 6: new o.Vector4(1, 0.66, 0, 1), 7: new o.Vector4(1, 0, 1, 1), 8: new o.Vector4(1, 0, 0, 1), 9: new o.Vector4(0, 0, 1, 1), 12: new o.Vector4(1, 1, 0, 1), DEFAULT: new o.Vector4(0.3, 0.6, 0.6, 0.5) };
var $ = [[0, new o.Color(0, 0, 0)], [1, new o.Color(1, 1, 1)]];
var w = [[0, new o.Color(0.077, 0.042, 0.206)], [0.1, new o.Color(0.225, 0.036, 0.388)], [0.2, new o.Color(0.373, 0.074, 0.432)], [0.3, new o.Color(0.522, 0.128, 0.42)], [0.4, new o.Color(0.665, 0.182, 0.37)], [0.5, new o.Color(0.797, 0.255, 0.287)], [0.6, new o.Color(0.902, 0.364, 0.184)], [0.7, new o.Color(0.969, 0.516, 0.063)], [0.8, new o.Color(0.988, 0.683, 0.072)], [0.9, new o.Color(0.961, 0.859, 0.298)], [1, new o.Color(0.988, 0.998, 0.645)]];
var X = [[0, new o.Color(0.241, 0.015, 0.61)], [0.1, new o.Color(0.387, 1e-3, 0.654)], [0.2, new o.Color(0.524, 0.025, 0.653)], [0.3, new o.Color(0.651, 0.125, 0.596)], [0.4, new o.Color(0.752, 0.227, 0.513)], [0.5, new o.Color(0.837, 0.329, 0.431)], [0.6, new o.Color(0.907, 0.435, 0.353)], [0.7, new o.Color(0.963, 0.554, 0.272)], [0.8, new o.Color(0.992, 0.681, 0.195)], [0.9, new o.Color(0.987, 0.822, 0.144)], [1, new o.Color(0.94, 0.975, 0.131)]];
var x = [[0, new o.Color(0.278, 0, 0.714)], [1 / 6, new o.Color(0, 0, 1)], [2 / 6, new o.Color(0, 1, 1)], [0.5, new o.Color(0, 1, 0)], [4 / 6, new o.Color(1, 1, 0)], [5 / 6, new o.Color(1, 0.64, 0)], [1, new o.Color(1, 0, 0)]];
var Y = [[0, new o.Color(0.3686, 0.3098, 0.6353)], [0.1, new o.Color(0.1961, 0.5333, 0.7412)], [0.2, new o.Color(0.4, 0.7608, 0.6471)], [0.3, new o.Color(0.6706, 0.8667, 0.6431)], [0.4, new o.Color(0.902, 0.9608, 0.5961)], [0.5, new o.Color(1, 1, 0.749)], [0.6, new o.Color(0.9961, 0.8784, 0.5451)], [0.7, new o.Color(0.9922, 0.6824, 0.3804)], [0.8, new o.Color(0.9569, 0.4275, 0.2627)], [0.9, new o.Color(0.8353, 0.2431, 0.3098)], [1, new o.Color(0.6196, 39e-4, 0.2588)]];
var A = [[0, new o.Color(0.267, 5e-3, 0.329)], [0.1, new o.Color(0.283, 0.141, 0.458)], [0.2, new o.Color(0.254, 0.265, 0.53)], [0.3, new o.Color(0.207, 0.372, 0.553)], [0.4, new o.Color(0.164, 0.471, 0.558)], [0.5, new o.Color(0.128, 0.567, 0.551)], [0.6, new o.Color(0.135, 0.659, 0.518)], [0.7, new o.Color(0.267, 0.749, 0.441)], [0.8, new o.Color(0.478, 0.821, 0.318)], [0.9, new o.Color(0.741, 0.873, 0.15)], [1, new o.Color(0.993, 0.906, 0.144)]];
var T = [[0, new o.Color(0.1647, 0.2824, 0.3451)], [0.1, new o.Color(0.1338, 0.3555, 0.4227)], [0.2, new o.Color(0.061, 0.4319, 0.4864)], [0.3, new o.Color(0, 0.5099, 0.5319)], [0.4, new o.Color(0, 0.5881, 0.5569)], [0.5, new o.Color(0.137, 0.665, 0.5614)], [0.6, new o.Color(0.2906, 0.7395, 0.5477)], [0.7, new o.Color(0.4453, 0.8099, 0.5201)], [0.8, new o.Color(0.6102, 0.8748, 0.485)], [0.9, new o.Color(0.7883, 0.9323, 0.4514)], [1, new o.Color(0.9804, 0.9804, 0.4314)]];
function C(e2, t2, n2) {
  const i2 = e2 * t2, r2 = new Uint8Array(4 * i2), a2 = Math.floor(255 * n2.r), s2 = Math.floor(255 * n2.g), l2 = Math.floor(255 * n2.b);
  for (let e3 = 0; e3 < i2; e3++)
    r2[3 * e3] = a2, r2[3 * e3 + 1] = s2, r2[3 * e3 + 2] = l2;
  const c2 = new o.DataTexture(r2, e2, t2, o.RGBAFormat);
  return c2.needsUpdate = true, c2.magFilter = o.NearestFilter, c2;
}
function Q(e2) {
  if ("undefined" == typeof window || "undefined" == typeof document)
    return new o.Texture();
  const t2 = 64, n2 = document.createElement("canvas");
  n2.width = t2, n2.height = t2;
  const i2 = n2.getContext("2d");
  i2.rect(0, 0, t2, t2);
  const r2 = i2.createLinearGradient(0, 0, t2, t2);
  for (let t3 = 0; t3 < e2.length; t3++) {
    const n3 = e2[t3];
    r2.addColorStop(n3[0], `#${n3[1].getHexString()}`);
  }
  i2.fillStyle = r2, i2.fill();
  const a2 = new o.CanvasTexture(n2);
  return a2.needsUpdate = true, a2.minFilter = o.LinearFilter, a2;
}
function _(e2) {
  const t2 = new Uint8Array(262144);
  for (let n3 = 0; n3 < 256; n3++)
    for (let i2 = 0; i2 < 256; i2++) {
      const r2 = n3 + 256 * i2;
      let o2;
      o2 = e2[n3] ? e2[n3] : e2[n3 % 32] ? e2[n3 % 32] : e2.DEFAULT, t2[4 * r2 + 0] = 255 * o2.x, t2[4 * r2 + 1] = 255 * o2.y, t2[4 * r2 + 2] = 255 * o2.z, t2[4 * r2 + 3] = 255 * o2.w;
    }
  const n2 = new o.DataTexture(t2, 256, 256, o.RGBAFormat);
  return n2.magFilter = o.NearestFilter, n2.needsUpdate = true, n2;
}
var I;
!function(e2) {
  e2[e2.LINEAR = 0] = "LINEAR", e2[e2.SRGB = 1] = "SRGB";
}(I || (I = {}));
var S = function(e2, t2, n2, i2) {
  var r2, o2 = arguments.length, a2 = o2 < 3 ? t2 : null === i2 ? i2 = Object.getOwnPropertyDescriptor(t2, n2) : i2;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
    a2 = Reflect.decorate(e2, t2, n2, i2);
  else
    for (var s2 = e2.length - 1; s2 >= 0; s2--)
      (r2 = e2[s2]) && (a2 = (o2 < 3 ? r2(a2) : o2 > 3 ? r2(t2, n2, a2) : r2(t2, n2)) || a2);
  return o2 > 3 && a2 && Object.defineProperty(t2, n2, a2), a2;
};
var O = i(26).A;
var B = i(650).A;
var N = { [h.OCTREE]: "tree_type_octree", [h.KDTREE]: "tree_type_kdtree" };
var k = { [c.FIXED]: "fixed_point_size", [c.ATTENUATED]: "attenuated_point_size", [c.ADAPTIVE]: "adaptive_point_size" };
var E = { [f.ATTENUATED]: "attenuated_opacity", [f.FIXED]: "fixed_opacity" };
var D = { [d.SQUARE]: "square_point_shape", [d.CIRCLE]: "circle_point_shape", [d.PARABOLOID]: "paraboloid_point_shape" };
var L = { [u.RGB]: "color_type_rgb", [u.COLOR]: "color_type_color", [u.DEPTH]: "color_type_depth", [u.HEIGHT]: "color_type_height", [u.INTENSITY]: "color_type_intensity", [u.INTENSITY_GRADIENT]: "color_type_intensity_gradient", [u.LOD]: "color_type_lod", [u.POINT_INDEX]: "color_type_point_index", [u.CLASSIFICATION]: "color_type_classification", [u.RETURN_NUMBER]: "color_type_return_number", [u.SOURCE]: "color_type_source", [u.NORMAL]: "color_type_normal", [u.PHONG]: "color_type_phong", [u.RGB_HEIGHT]: "color_type_rgb_height", [u.COMPOSITE]: "color_type_composite" };
var R = { [l.DISABLED]: "clip_disabled", [l.CLIP_OUTSIDE]: "clip_outside", [l.CLIP_INSIDE]: "clip_inside", [l.HIGHLIGHT_INSIDE]: "clip_highlight_inside" };
var z = { [I.LINEAR]: "input_color_encoding_linear", [I.SRGB]: "input_color_encoding_sRGB" };
var M = { [I.LINEAR]: "output_color_encoding_linear", [I.SRGB]: "output_color_encoding_sRGB" };
var U = class _U extends o.RawShaderMaterial {
  constructor(e2 = {}) {
    super(), this.lights = false, this.fog = false, this.numClipBoxes = 0, this.clipBoxes = [], this.visibleNodeTextureOffsets = /* @__PURE__ */ new Map(), this._gradient = Y, this.gradientTexture = Q(this._gradient), this._classification = y, this.classificationTexture = _(this._classification), this.uniforms = { bbSize: F("fv", [0, 0, 0]), blendDepthSupplement: F("f", 0), blendHardness: F("f", 2), classificationLUT: F("t", this.classificationTexture || new o.Texture()), clipBoxCount: F("f", 0), clipBoxes: F("Matrix4fv", []), depthMap: F("t", null), diffuse: F("fv", [1, 1, 1]), fov: F("f", 1), gradient: F("t", this.gradientTexture || new o.Texture()), heightMax: F("f", 1), heightMin: F("f", 0), intensityBrightness: F("f", 0), intensityContrast: F("f", 0), intensityGamma: F("f", 1), intensityRange: F("fv", [0, 65e3]), isLeafNode: F("b", 0), level: F("f", 0), maxSize: F("f", 50), minSize: F("f", 2), octreeSize: F("f", 0), opacity: F("f", 1), pcIndex: F("f", 0), rgbBrightness: F("f", 0), rgbContrast: F("f", 0), rgbGamma: F("f", 1), screenHeight: F("f", 1), screenWidth: F("f", 1), useOrthographicCamera: F("b", false), orthoHeight: F("f", 1), orthoWidth: F("f", 1), far: F("f", 1e3), size: F("f", 1), spacing: F("f", 1), toModel: F("Matrix4f", []), transition: F("f", 0.5), uColor: F("c", new o.Color(16777215)), visibleNodes: F("t", this.visibleNodesTexture || new o.Texture()), vnStart: F("f", 0), wClassification: F("f", 0), wElevation: F("f", 0), wIntensity: F("f", 0), wReturnNumber: F("f", 0), wRGB: F("f", 1), wSourceID: F("f", 0), opacityAttenuation: F("f", 1), filterByNormalThreshold: F("f", 0), highlightedPointCoordinate: F("fv", new o.Vector3()), highlightedPointColor: F("fv", P.clone()), enablePointHighlighting: F("b", true), highlightedPointScale: F("f", 2) }, this.useClipBox = false, this.weighted = false, this.pointColorType = u.RGB, this.pointSizeType = c.ADAPTIVE, this.clipMode = l.DISABLED, this.useEDL = false, this.shape = d.SQUARE, this.treeType = h.OCTREE, this.pointOpacityType = f.FIXED, this.useFilterByNormal = false, this.highlightPoint = false, this.inputColorEncoding = I.SRGB, this.outputColorEncoding = I.LINEAR, this.useLogDepth = false, this.attributes = { position: { type: "fv", value: [] }, color: { type: "fv", value: [] }, normal: { type: "fv", value: [] }, intensity: { type: "f", value: [] }, classification: { type: "f", value: [] }, returnNumber: { type: "f", value: [] }, numberOfReturns: { type: "f", value: [] }, pointSourceID: { type: "f", value: [] }, indices: { type: "fv", value: [] } };
    const t2 = this.visibleNodesTexture = C(2048, 1, new o.Color(16777215));
    t2.minFilter = o.NearestFilter, t2.magFilter = o.NearestFilter, this.setUniform("visibleNodes", t2), this.treeType = j(e2.treeType, h.OCTREE), this.size = j(e2.size, 1), this.minSize = j(e2.minSize, 2), this.maxSize = j(e2.maxSize, 50), this.newFormat = Boolean(e2.newFormat), this.classification = y, this.defaultAttributeValues.normal = [0, 0, 0], this.defaultAttributeValues.classification = [0, 0, 0], this.defaultAttributeValues.indices = [0, 0, 0, 0], this.vertexColors = true, this.updateShaderSource();
  }
  dispose() {
  ...
  updateShaderSource() {
    this.glslVersion = o.GLSL3, this.vertexShader = this.applyDefines(O), this.fragmentShader = this.applyDefines(B), 1 === this.opacity ? (this.blending = o.NoBlending, this.transparent = false, this.depthTest = true, this.depthWrite = true, this.depthFunc = o.LessEqualDepth) : this.opacity < 1 && !this.useEDL && (this.blending = o.AdditiveBlending, this.transparent = true, this.depthTest = false, this.depthWrite = true), this.weighted && (this.blending = o.AdditiveBlending, this.transparent = true, this.depthTest = true, this.depthWrite = false, this.depthFunc = o.LessEqualDepth), this.needsUpdate = true;
  }
  applyDefines(e2) {
    const t2 = [];
    function n2(e3) {
      e3 && t2.push(`#define ${e3}`);
    }
    n2(N[this.treeType]), n2(k[this.pointSizeType]), n2(D[this.shape]), n2(L[this.pointColorType]), n2(R[this.clipMode]), n2(E[this.pointOpacityType]), n2(M[this.outputColorEncoding]), n2(z[this.inputColorEncoding]), 1 === this.rgbGamma && 0 === this.rgbBrightness && 0 === this.rgbContrast || n2("use_rgb_gamma_contrast_brightness"), this.useFilterByNormal && n2("use_filter_by_normal"), this.useEDL && n2("use_edl"), this.useLogDepth && n2("use_log_depth"), this.weighted && n2("weighted_splats"), this.numClipBoxes > 0 && n2("use_clip_box"), this.highlightPoint && n2("highlight_point"), n2("MAX_POINT_LIGHTS 0"), n2("MAX_DIR_LIGHTS 0"), this.newFormat && n2("new_format");
    const i2 = e2.match(/^\s*#version\s+300\s+es\s*\n/);
    return i2 && (t2.unshift(i2[0]), e2 = e2.replace(i2[0], "")), t2.push(e2), t2.join("\n");
  }
  setClipBoxes(e2) {
    if (!e2)
      return;
    this.clipBoxes = e2;
    const t2 = this.numClipBoxes !== e2.length && (0 === e2.length || 0 === this.numClipBoxes);
    this.numClipBoxes = e2.length, this.setUniform("clipBoxCount", this.numClipBoxes), t2 && this.updateShaderSource();
    const n2 = 16 * this.numClipBoxes, i2 = new Float32Array(n2);
    for (let t3 = 0; t3 < this.numClipBoxes; t3++)
      i2.set(e2[t3].inverse.elements, 16 * t3);
    for (let e3 = 0; e3 < n2; e3++)
      isNaN(i2[e3]) && (i2[e3] = 1 / 0);
    this.setUniform("clipBoxes", i2);
  }
  get gradient() {
    return this._gradient;
  }
  set gradient(e2) {
    this._gradient !== e2 && (this._gradient = e2, this.gradientTexture = Q(this._gradient), this.setUniform("gradient", this.gradientTexture));
  }
  get classification() {
    return this._classification;
  }
  set classification(e2) {
    const t2 = {};
    ...
    if (void 0 === this._classification)
      ...
      n2 = Object.keys(t2).length === Object.keys(this._classification).length;
      for (const e3 of Object.keys(t2))
        n2 = n2 && void 0 !== this._classification[e3], n2 = n2 && t2[e3].equals(this._classification[e3]);
    }
    n2 || (this._classification = t2, this.recomputeClassification());
  }
  recomputeClassification() {
    this.classificationTexture = _(this._classification), this.setUniform("classificationLUT", this.classificationTexture);
  }
  get elevationRange() {
    return [this.heightMin, this.heightMax];
  }
  set elevationRange(e2) {
    this.heightMin = e2[0], this.heightMax = e2[1];
  }
  getUniform(e2) {
    return void 0 === this.uniforms ? void 0 : this.uniforms[e2].value;
  }
  setUniform(e2, t2) {
    if (void 0 === this.uniforms)
      return;
    const n2 = this.uniforms[e2];
    "c" === n2.type ? n2.value.copy(t2) : t2 !== n2.value && (n2.value = t2);
  }
  updateMaterial(e2, t2, n2, i2) {
    const r2 = i2.getPixelRatio();
    if (n2.type === m)
      this.useOrthographicCamera = false, this.fov = n2.fov * (Math.PI / 180), this.far = n2.far, this.useLogDepth = i2.capabilities.logarithmicDepthBuffer;
    else {
      const e3 = n2;
      this.useOrthographicCamera = true, this.orthoWidth = (e3.right - e3.left) / e3.zoom, this.orthoHeight = (e3.top - e3.bottom) / e3.zoom, this.fov = Math.PI / 2, this.far = n2.far, this.useLogDepth = false;
    }
    const a2 = i2.getRenderTarget();
    null !== a2 && a2 instanceof o.WebGLRenderTarget ? (this.screenWidth = a2.width, this.screenHeight = a2.height) : (this.screenWidth = i2.domElement.clientWidth * r2, this.screenHeight = i2.domElement.clientHeight * r2);
    const s2 = Math.max(e2.scale.x, e2.scale.y, e2.scale.z);
    this.spacing = e2.pcoGeometry.spacing * s2, this.octreeSize = e2.pcoGeometry.boundingBox.getSize(_U.helperVec3).x, this.pointSizeType !== c.ADAPTIVE && this.pointColorType !== u.LOD || this.updateVisibilityTextureData(t2);
  }
  updateVisibilityTextureData(e2) {
    e2.sort(v);
    const t2 = new Uint8Array(4 * e2.length), n2 = new Array(e2.length).fill(1 / 0);
    this.visibleNodeTextureOffsets.clear();
    for (let i3 = 0; i3 < e2.length; i3++) {
      const r2 = e2[i3];
      if (this.visibleNodeTextureOffsets.set(r2.name, i3), i3 > 0) {
        const e3 = r2.name.slice(0, -1), o2 = this.visibleNodeTextureOffsets.get(e3), a2 = i3 - o2;
        n2[o2] = Math.min(n2[o2], a2);
        const s2 = 4 * o2;
        t2[s2] = t2[s2] | 1 << r2.index, t2[s2 + 1] = n2[o2] >> 8, t2[s2 + 2] = n2[o2] % 256;
      }
      t2[4 * i3 + 3] = r2.name.length;
    }
    const i2 = this.visibleNodesTexture;
    i2 && (i2.image.data.set(t2), i2.needsUpdate = true);
  }
  static makeOnBeforeRender(e2, t2, n2) {
    return (i2, r2, o2, a2, s2) => {
      const l2 = s2, c2 = l2.uniforms;
      c2.level.value = t2.level, c2.isLeafNode.value = t2.isLeafNode;
      const d2 = l2.visibleNodeTextureOffsets.get(t2.name);
      void 0 !== d2 && (c2.vnStart.value = d2), c2.pcIndex.value = void 0 !== n2 ? n2 : e2.visibleNodes.indexOf(t2), s2.uniformsNeedUpdate = true;
    };
  }
};
function F(e2, t2) {
...
function G(e2, t2 = false) {
  return (n2, i2) => {
    Object.defineProperty(n2, i2, { get: function() {
      return this.getUniform(e2);
    }, set: function(n3) {
      n3 !== this.getUniform(e2) && (this.setUniform(e2, n3), t2 && this.updateShaderSource());
    } });
  };
}
function H() {
  return (e2, t2) => {
    const n2 = `_${t2.toString()}`;
    Object.defineProperty(e2, t2, { get: function() {
      return this[n2];
    }, set: function(e3) {
      e3 !== this[n2] && (this[n2] = e3, this.updateShaderSource());
    } });
  };
}
var q;
U.helperVec3 = new o.Vector3(), S([G("bbSize")], U.prototype, "bbSize", void 0), S([G("depthMap")], U.prototype, "depthMap", void 0), S([G("fov")], U.prototype, "fov", void 0), S([G("heightMax")], U.prototype, "heightMax", void 0), S([G("heightMin")], U.prototype, "heightMin", void 0), S([G("intensityBrightness")], U.prototype, "intensityBrightness", void 0), S([G("intensityContrast")], U.prototype, "intensityContrast", void 0), S([G("intensityGamma")], U.prototype, "intensityGamma", void 0), S([G("intensityRange")], U.prototype, "intensityRange", void 0), S([G("maxSize")], U.prototype, "maxSize", void 0), S([G("minSize")], U.prototype, "minSize", void 0), S([G("octreeSize")], U.prototype, "octreeSize", void 0), S([G("opacity", true)], U.prototype, "opacity", void 0), S([G("rgbBrightness", true)], U.prototype, "rgbBrightness", void 0), S([G("rgbContrast", true)], U.prototype, "rgbContrast", void 0), S([G("rgbGamma", true)], U.prototype, "rgbGamma", void 0), S([G("screenHeight")], U.prototype, "screenHeight", void 0), S([G("screenWidth")], U.prototype, "screenWidth", void 0), S([G("orthoWidth")], U.prototype, "orthoWidth", void 0), S([G("orthoHeight")], U.prototype, "orthoHeight", void 0), S([G("useOrthographicCamera")], U.prototype, "useOrthographicCamera", void 0), S([G("far")], U.prototype, "far", void 0), S([G("size")], U.prototype, "size", void 0), S([G("spacing")], U.prototype, "spacing", void 0), S([G("transition")], U.prototype, "transition", void 0), S([G("uColor")], U.prototype, "color", void 0), S([G("wClassification")], U.prototype, "weightClassification", void 0), S([G("wElevation")], U.prototype, "weightElevation", void 0), S([G("wIntensity")], U.prototype, "weightIntensity", void 0), S([G("wReturnNumber")], U.prototype, "weightReturnNumber", void 0), S([G("wRGB")], U.prototype, "weightRGB", void 0), S([G("wSourceID")], U.prototype, "weightSourceID", void 0), S([G("opacityAttenuation")], U.prototype, "opacityAttenuation", void 0), S([G("filterByNormalThreshold")], U.prototype, "filterByNormalThreshold", void 0), S([G("highlightedPointCoordinate")], U.prototype, "highlightedPointCoordinate", void 0), S([G("highlightedPointColor")], U.prototype, "highlightedPointColor", void 0), S([G("enablePointHighlighting")], U.prototype, "enablePointHighlighting", void 0), S([G("highlightedPointScale")], U.prototype, "highlightedPointScale", void 0), S([H()], U.prototype, "useClipBox", void 0), S([H()], U.prototype, "weighted", void 0), S([H()], U.prototype, "pointColorType", void 0), S([H()], U.prototype, "pointSizeType", void 0), S([H()], U.prototype, "clipMode", void 0), S([H()], U.prototype, "useEDL", void 0), S([H()], U.prototype, "shape", void 0), S([H()], U.prototype, "treeType", void 0), S([H()], U.prototype, "pointOpacityType", void 0), S([H()], U.prototype, "useFilterByNormal", void 0), S([H()], U.prototype, "highlightPoint", void 0), S([H()], U.prototype, "inputColorEncoding", void 0), S([H()], U.prototype, "outputColorEncoding", void 0), S([H()], U.prototype, "useLogDepth", void 0), function(e2) {
  e2[e2.POSITION_CARTESIAN = 0] = "POSITION_CARTESIAN", e2[e2.COLOR_PACKED = 1] = "COLOR_PACKED", e2[e2.COLOR_FLOATS_1 = 2] = "COLOR_FLOATS_1", e2[e2.COLOR_FLOATS_255 = 3] = "COLOR_FLOATS_255", e2[e2.NORMAL_FLOATS = 4] = "NORMAL_FLOATS", e2[e2.FILLER = 5] = "FILLER", e2[e2.INTENSITY = 6] = "INTENSITY", e2[e2.CLASSIFICATION = 7] = "CLASSIFICATION", e2[e2.NORMAL_SPHEREMAPPED = 8] = "NORMAL_SPHEREMAPPED", e2[e2.NORMAL_OCT16 = 9] = "NORMAL_OCT16", e2[e2.NORMAL = 10] = "NORMAL";
}(q || (q = {}));
var V = { DATA_TYPE_DOUBLE: { ordinal: 0, size: 8 }, DATA_TYPE_FLOAT: { ordinal: 1, size: 4 }, DATA_TYPE_INT8: { ordinal: 2, size: 1 }, DATA_TYPE_UINT8: { ordinal: 3, size: 1 }, DATA_TYPE_INT16: { ordinal: 4, size: 2 }, DATA_TYPE_UINT16: { ordinal: 5, size: 2 }, DATA_TYPE_INT32: { ordinal: 6, size: 4 }, DATA_TYPE_UINT32: { ordinal: 7, size: 4 }, DATA_TYPE_INT64: { ordinal: 8, size: 8 }, DATA_TYPE_UINT64: { ordinal: 9, size: 8 } };
function W(e2, t2, n2) {
  return { name: e2, type: t2, numElements: n2, byteSize: n2 * t2.size };
}
var K = W(q.COLOR_PACKED, V.DATA_TYPE_INT8, 4);
var J = { POSITION_CARTESIAN: W(q.POSITION_CARTESIAN, V.DATA_TYPE_FLOAT, 3), RGBA_PACKED: K, COLOR_PACKED: K, RGB_PACKED: W(q.COLOR_PACKED, V.DATA_TYPE_INT8, 3), NORMAL_FLOATS: W(q.NORMAL_FLOATS, V.DATA_TYPE_FLOAT, 3), FILLER_1B: W(q.FILLER, V.DATA_TYPE_UINT8, 1), INTENSITY: W(q.INTENSITY, V.DATA_TYPE_UINT16, 1), CLASSIFICATION: W(q.CLASSIFICATION, V.DATA_TYPE_UINT8, 1), NORMAL_SPHEREMAPPED: W(q.NORMAL_SPHEREMAPPED, V.DATA_TYPE_UINT8, 2), NORMAL_OCT16: W(q.NORMAL_OCT16, V.DATA_TYPE_UINT8, 2), NORMAL: W(q.NORMAL, V.DATA_TYPE_FLOAT, 3) };
var Z = class {
  constructor(e2 = []) {
    this.attributes = [], this.byteSize = 0, this.size = 0;
    for (let t2 = 0; t2 < e2.length; t2++) {
      const n2 = e2[t2], i2 = J[n2];
      try {
        this.attributes.push(i2), this.byteSize += i2.byteSize, this.size++;
      } catch (e3) {
      }
    }
  }
  add(e2) {
    this.attributes.push(e2), this.byteSize += e2.byteSize, this.size++;
  }
  hasColors() {
    return void 0 !== this.attributes.find(ee);
  }
  hasNormals() {
    return void 0 !== this.attributes.find(te);
  }
};
function ee({ name: e2 }) {
  return e2 === q.COLOR_PACKED;
}
function te({ name: e2 }) {
  return e2 === q.NORMAL_SPHEREMAPPED || e2 === q.NORMAL_FLOATS || e2 === q.NORMAL || e2 === q.NORMAL_OCT16;
}
function ne(e2, t2) {
  return new o.Box3().setFromPoints([new o.Vector3(e2.min.x, e2.min.y, e2.min.z).applyMatrix4(t2), new o.Vector3(e2.min.x, e2.min.y, e2.min.z).applyMatrix4(t2), new o.Vector3(e2.max.x, e2.min.y, e2.min.z).applyMatrix4(t2), new o.Vector3(e2.min.x, e2.max.y, e2.min.z).applyMatrix4(t2), new o.Vector3(e2.min.x, e2.min.y, e2.max.z).applyMatrix4(t2), new o.Vector3(e2.min.x, e2.max.y, e2.max.z).applyMatrix4(t2), new o.Vector3(e2.max.x, e2.max.y, e2.min.z).applyMatrix4(t2), new o.Vector3(e2.max.x, e2.min.y, e2.max.z).applyMatrix4(t2), new o.Vector3(e2.max.x, e2.max.y, e2.max.z).applyMatrix4(t2)]);
}
function ie(e2, t2) {
  const n2 = e2.min.clone(), i2 = e2.max.clone(), r2 = new o.Vector3().subVectors(i2, n2);
  return (1 & t2) > 0 ? n2.z += r2.z / 2 : i2.z -= r2.z / 2, (2 & t2) > 0 ? n2.y += r2.y / 2 : i2.y -= r2.y / 2, (4 & t2) > 0 ? n2.x += r2.x / 2 : i2.x -= r2.x / 2, new o.Box3(n2, i2);
}
var re = class _re extends o.EventDispatcher {
  constructor(e2, t2, n2) {
    super(), this.id = _re.idCount++, this.level = 0, this.spacing = 0, this.hasChildren = false, this.children = [null, null, null, null, null, null, null, null], this.mean = new o.Vector3(), this.numPoints = 0, this.loaded = false, this.loading = false, this.failed = false, this.parent = null, this.oneTimeDisposeHandlers = [], this.isLeafNode = true, this.isTreeNode = false, this.isGeometryNode = true, this.name = e2, this.index = b(e2), this.pcoGeometry = t2, this.boundingBox = n2, this.tightBoundingBox = n2.clone(), this.boundingSphere = n2.getBoundingSphere(new o.Sphere());
  }
  dispose() {
    this.geometry && this.parent && (this.geometry.dispose(), this.geometry = void 0, this.loaded = false, this.oneTimeDisposeHandlers.forEach((e2) => e2()), this.oneTimeDisposeHandlers = []);
  }
  getUrl() {
    const e2 = this.pcoGeometry, t2 = e2.loader.version, n2 = [e2.octreeDir];
    return e2.loader && t2.equalOrHigher("1.5") ? (n2.push(this.getHierarchyBaseUrl()), n2.push(this.name)) : (t2.equalOrHigher("1.4") || t2.upTo("1.3")) && n2.push(this.name), n2.join("/");
  }
  getHierarchyUrl() {
    return `${this.pcoGeometry.octreeDir}/${this.getHierarchyBaseUrl()}/${this.name}.hrc`;
  }
  addChild(e2) {
    this.children[e2.index] = e2, this.isLeafNode = false, e2.parent = this;
  }
  traverse(e2, t2 = true) {
    const n2 = t2 ? [this] : [];
    let i2;
    for (; void 0 !== (i2 = n2.pop()); ) {
      e2(i2);
  ...
  load() {
    ...
    let e2;
    return this.loading = true, this.pcoGeometry.numNodesLoading++, this.pcoGeometry.needsUpdate = true, e2 = this.pcoGeometry.loader.version.equalOrHigher("1.5") && this.level % this.pcoGeometry.hierarchyStepSize == 0 && this.hasChildren ? this.loadHierachyThenPoints() : this.loadPoints(), e2.catch((e3) => {
      throw this.loading = false, this.failed = true, this.pcoGeometry.numNodesLoading--, e3;
    });
  }
  canLoad() {
  ...
  loadPoints() {
    return this.pcoGeometry.needsUpdate = true, this.pcoGeometry.loader.load(this);
  }
  loadHierachyThenPoints() {
    return this.level % this.pcoGeometry.hierarchyStepSize != 0 ? Promise.resolve() : Promise.resolve(this.pcoGeometry.loader.getUrl(this.getHierarchyUrl())).then((e2) => this.pcoGeometry.xhrRequest(e2, { mode: "cors" })).then((e2) => e2.arrayBuffer()).then((e2) => this.loadHierarchy(this, e2));
  }
  getHierarchyBaseUrl() {
    const e2 = this.pcoGeometry.hierarchyStepSize, t2 = this.name.substr(1), n2 = Math.floor(t2.length / e2);
    let i2 = "r/";
    for (let r2 = 0; r2 < n2; r2++)
      i2 += `${t2.substr(r2 * e2, e2)}/`;
    return i2.slice(0, -1);
  }
  loadHierarchy(e2, t2) {
    const n2 = new DataView(t2), i2 = this.getNodeData(e2.name, 0, n2);
    e2.numPoints = i2.numPoints;
    const r2 = [i2], o2 = [];
    let a2 = 5;
    for (; r2.length > 0; ) {
      const e3 = r2.shift();
      let i3 = 1;
      for (let s3 = 0; s3 < 8 && a2 + 1 < t2.byteLength; s3++) {
        if (e3.children & i3) {
          const t3 = this.getNodeData(e3.name + s3, a2, n2);
          o2.push(t3), r2.push(t3), a2 += 5;
        }
        i3 *= 2;
      }
    }
    e2.pcoGeometry.needsUpdate = true;
    const s2 = /* @__PURE__ */ new Map();
    s2.set(e2.name, e2), o2.forEach((t3) => this.addNode(t3, e2.pcoGeometry, s2)), e2.loadPoints();
  }
  getNodeData(e2, t2, n2) {
    return { children: n2.getUint8(t2), numPoints: n2.getUint32(t2 + 1, true), name: e2 };
  }
  addNode({ name: e2, numPoints: t2, children: n2 }, i2, r2) {
    const o2 = b(e2), a2 = e2.substring(0, e2.length - 1), s2 = r2.get(a2), l2 = e2.length - 1, c2 = ie(s2.boundingBox, o2), d2 = new _re(e2, i2, c2);
    d2.level = l2, d2.numPoints = t2, d2.hasChildren = n2 > 0, d2.spacing = i2.spacing / Math.pow(2, l2), s2.addChild(d2), r2.set(e2, d2);
  }
};
re.idCount = 0;
var oe = class {
  constructor(e2, t2, n2, i2, r2) {
    this.loader = e2, this.boundingBox = t2, this.tightBoundingBox = n2, this.offset = i2, this.xhrRequest = r2, this.disposed = false, this.needsUpdate = true, this.octreeDir = "", this.hierarchyStepSize = -1, this.nodes = {}, this.numNodesLoading = 0, this.maxNumNodesLoading = 3, this.spacing = 0, this.pointAttributes = new Z([]), this.projection = null, this.url = null;
  }
  dispose() {
    this.loader.dispose(), this.root.traverse((e2) => e2.dispose()), this.disposed = true;
  }
  addNodeLoadedCallback(e2) {
    this.loader.callbacks.push(e2);
  }
  clearNodeLoadedCallbacks() {
    this.loader.callbacks = [];
  }
};
var ae = class extends o.EventDispatcher {
  constructor(e2, t2) {
    super(), this.pcIndex = void 0, this.boundingBoxNode = null, this.loaded = true, this.isTreeNode = true, this.isGeometryNode = false, this.geometryNode = e2, this.sceneNode = t2, this.children = e2.children.slice();
  }
  dispose() {
    this.geometryNode.dispose();
  }
  disposeSceneNode() {
    const e2 = this.sceneNode;
    if (e2.geometry instanceof o.BufferGeometry) {
      const t2 = e2.geometry.attributes;
      for (const e3 in t2)
        "position" === e3 && delete t2[e3].array, delete t2[e3];
      e2.geometry.dispose(), e2.geometry = void 0;
    }
  }
  traverse(e2, t2) {
    this.geometryNode.traverse(e2, t2);
  }
  get id() {
...
var le = class _le {
  ...
  pick(e2, t2, n2, i2, r2 = {}) {
    if (0 === i2.length)
      return null;
    const o2 = this.pickState ? this.pickState : this.pickState = _le.getPickState(), a2 = o2.material, s2 = e2.getPixelRatio(), l2 = Math.ceil(e2.domElement.clientWidth * s2), c2 = Math.ceil(e2.domElement.clientHeight * s2);
    _le.updatePickRenderTarget(this.pickState, l2, c2);
    const d2 = _le.helperVec3;
    r2.pixelPosition ? d2.copy(r2.pixelPosition) : (d2.addVectors(t2.position, n2.direction).project(t2), d2.x = (d2.x + 1) * l2 * 0.5, d2.y = (d2.y + 1) * c2 * 0.5);
    const h2 = Math.floor((r2.pickWindowSize || 15) * s2), f2 = (h2 - 1) / 2, u2 = Math.floor(se(d2.x - f2, 0, l2)), p2 = Math.floor(se(d2.y - f2, 0, c2));
    _le.prepareRender(e2, u2, p2, h2, a2, o2);
    const m2 = _le.render(e2, t2, a2, i2, n2, o2, r2);
    a2.clearVisibleNodeTextureOffsets();
    const g2 = _le.readPixels(e2, u2, p2, h2), P2 = _le.findHit(g2, h2);
    return _le.getPickPoint(P2, m2);
  }
  static prepareRender(e2, t2, n2, i2, r2, a2) {
    e2.setScissor(t2, n2, i2, i2), e2.setScissorTest(true), e2.state.buffers.depth.setTest(r2.depthTest), e2.state.buffers.depth.setMask(r2.depthWrite), e2.state.setBlending(o.NoBlending), e2.setRenderTarget(a2.renderTarget), e2.getClearColor(this.clearColor);
    const s2 = e2.getClearAlpha();
    e2.setClearColor(g, 0), e2.clear(true, true, true), e2.setClearColor(this.clearColor, s2);
  }
  static render(e2, t2, n2, i2, r2, o2, a2) {
    const s2 = [];
    for (const l2 of i2) {
      const i3 = _le.nodesOnRay(l2, r2);
      i3.length && (_le.updatePickMaterial(n2, l2.material, a2), n2.updateMaterial(l2, i3, t2, e2), a2.onBeforePickRender && a2.onBeforePickRender(n2, o2.renderTarget), o2.scene.children = _le.createTempNodes(l2, i3, n2, s2.length), e2.render(o2.scene, t2), i3.forEach((e3) => s2.push({ node: e3, octree: l2 })));
    }
    return s2;
  }
  static nodesOnRay(e2, t2) {
    const n2 = [], i2 = t2.clone();
    for (const t3 of e2.visibleNodes) {
      const r2 = _le.helperSphere.copy(t3.boundingSphere).applyMatrix4(e2.matrixWorld);
      i2.intersectsSphere(r2) && n2.push(t3);
    }
    return n2;
  }
  static readPixels(e2, t2, n2, i2) {
    const r2 = new Uint8Array(4 * i2 * i2);
    return e2.readRenderTargetPixels(e2.getRenderTarget(), t2, n2, i2, i2, r2), e2.setScissorTest(false), e2.setRenderTarget(null), r2;
  }
  static createTempNodes(e2, t2, n2, i2) {
    const r2 = [];
    for (let a2 = 0; a2 < t2.length; a2++) {
      const s2 = t2[a2], l2 = s2.sceneNode, c2 = new o.Points(l2.geometry, n2);
      c2.matrix = l2.matrix, c2.matrixWorld = l2.matrixWorld, c2.matrixAutoUpdate = false, c2.frustumCulled = false;
      const d2 = i2 + a2 + 1;
      if (d2 > 255)
        throw Error("More than 255 nodes for pick are not supported.");
      c2.onBeforeRender = U.makeOnBeforeRender(e2, s2, d2), r2.push(c2);
    }
    return r2;
  }
  static updatePickMaterial(e2, t2, n2) {
    e2.pointSizeType = t2.pointSizeType, e2.shape = t2.shape, e2.size = t2.size, e2.minSize = t2.minSize, e2.maxSize = t2.maxSize, e2.classification = t2.classification, e2.useFilterByNormal = t2.useFilterByNormal, e2.filterByNormalThreshold = t2.filterByNormalThreshold, n2.pickOutsideClipRegion ? e2.clipMode = l.DISABLED : (e2.clipMode = t2.clipMode, e2.setClipBoxes(t2.clipMode === l.CLIP_OUTSIDE ? t2.clipBoxes : []));
  }
  static updatePickRenderTarget(e2, t2, n2) {
    e2.renderTarget.width === t2 && e2.renderTarget.height === n2 || (e2.renderTarget.dispose(), e2.renderTarget = _le.makePickRenderTarget(), e2.renderTarget.setSize(t2, n2));
  }
  static makePickRenderTarget() {
    return new o.WebGLRenderTarget(1, 1, { minFilter: o.LinearFilter, magFilter: o.NearestFilter, format: o.RGBAFormat });
  }
  static findHit(e2, t2) {
    const n2 = new Uint32Array(e2.buffer);
    let i2 = Number.MAX_VALUE, r2 = null;
    for (let o2 = 0; o2 < t2; o2++)
      for (let a2 = 0; a2 < t2; a2++) {
        const s2 = o2 + a2 * t2, l2 = Math.pow(o2 - (t2 - 1) / 2, 2) + Math.pow(a2 - (t2 - 1) / 2, 2), c2 = e2[4 * s2 + 3];
        e2[4 * s2 + 3] = 0;
        const d2 = n2[s2];
        c2 > 0 && l2 < i2 && (r2 = { pIndex: d2, pcIndex: c2 - 1 }, i2 = l2);
      }
    return r2;
  }
  static getPickPoint(e2, t2) {
    if (!e2)
      return null;
    const n2 = {}, i2 = t2[e2.pcIndex] && t2[e2.pcIndex].node.sceneNode;
    if (!i2)
      return null;
    n2.pointCloud = t2[e2.pcIndex].octree;
    const r2 = i2.geometry.attributes;
    for (const t3 in r2) {
      if (!r2.hasOwnProperty(t3))
        continue;
      const o2 = r2[t3];
      if ("position" === t3)
        _le.addPositionToPickPoint(n2, e2, o2, i2);
      else if ("normal" === t3)
        _le.addNormalToPickPoint(n2, e2, o2, i2);
      else if ("indices" === t3)
        ;
      else if (1 === o2.itemSize)
        n2[t3] = o2.array[e2.pIndex];
      else {
        const i3 = [];
        for (let t4 = 0; t4 < o2.itemSize; t4++)
          i3.push(o2.array[o2.itemSize * e2.pIndex + t4]);
        n2[t3] = i3;
      }
    }
    return n2;
  }
  static addPositionToPickPoint(e2, t2, n2, i2) {
    e2.position = new o.Vector3().fromBufferAttribute(n2, t2.pIndex).applyMatrix4(i2.matrixWorld);
  }
  static addNormalToPickPoint(e2, t2, n2, i2) {
    const r2 = new o.Vector3().fromBufferAttribute(n2, t2.pIndex), a2 = new o.Vector4(r2.x, r2.y, r2.z, 0).applyMatrix4(i2.matrixWorld);
    r2.set(a2.x, a2.y, a2.z), e2.normal = r2;
  }
  static getPickState() {
    const e2 = new o.Scene();
    e2.autoUpdate = false;
    const t2 = new U();
    return t2.pointColorType = u.POINT_INDEX, { renderTarget: _le.makePickRenderTarget(), material: t2, scene: e2 };
  }
};
le.helperVec3 = new o.Vector3(), le.helperSphere = new o.Sphere(), le.clearColor = new o.Color();
var ce = class {
  constructor(e2, t2) {
    this.loader = e2, this.boundingBox = t2, this.url = null, this.pointAttributes = null, this.spacing = 0, this.numNodesLoading = 0, this.maxNumNodesLoading = 3, this.disposed = false, this.tightBoundingBox = this.boundingBox.clone(), this.boundingSphere = this.boundingBox.getBoundingSphere(new o.Sphere()), this.tightBoundingSphere = this.boundingBox.getBoundingSphere(new o.Sphere());
  }
  dispose() {
    this.root.traverse((e2) => e2.dispose()), this.disposed = true;
  }
};
var de = class extends o.Object3D {
  constructor() {
...
var he = class extends de {
  constructor(e2, t2, n2) {
    super(), this.disposed = false, this.level = 0, this.maxLevel = 1 / 0, this.minNodePixelSize = 50, this.root = null, this.boundingBoxNodes = [], this.visibleNodes = [], this.visibleGeometry = [], this.numVisiblePoints = 0, this.showBoundingBox = false, this.visibleBounds = new o.Box3(), this.name = "", this.potree = e2, this.root = t2.root, this.pcoGeometry = t2, this.boundingBox = t2.boundingBox, this.boundingSphere = this.boundingBox.getBoundingSphere(new o.Sphere()), this.position.copy(t2.offset), this.updateMatrix(), this.material = n2 || t2 instanceof ce ? new U({ newFormat: true }) : new U(), this.initMaterial(this.material);
  }
  initMaterial(e2) {
    this.updateMatrixWorld(true);
    const { min: t2, max: n2 } = ne(this.pcoGeometry.tightBoundingBox || this.getBoundingBoxWorld(), this.matrixWorld), i2 = n2.z - t2.z;
    e2.heightMin = t2.z - 0.2 * i2, e2.heightMax = n2.z + 0.2 * i2;
  }
  dispose() {
    this.root && this.root.dispose(), this.pcoGeometry.root.traverse((e2) => this.potree.lru.remove(e2)), this.pcoGeometry.dispose(), this.material.dispose(), this.visibleNodes = [], this.visibleGeometry = [], this.picker && (this.picker.dispose(), this.picker = void 0), this.disposed = true;
  }
  get pointSizeType() {
    return this.material.pointSizeType;
  }
  set pointSizeType(e2) {
    this.material.pointSizeType = e2;
  }
  toTreeNode(e2, t2) {
    const n2 = new o.Points(e2.geometry, this.material), i2 = new ae(e2, n2);
    return n2.name = e2.name, n2.position.copy(e2.boundingBox.min), n2.frustumCulled = false, n2.onBeforeRender = U.makeOnBeforeRender(this, i2), t2 ? (t2.sceneNode.add(n2), t2.children[e2.index] = i2, e2.oneTimeDisposeHandlers.push(() => {
      i2.disposeSceneNode(), t2.sceneNode.remove(i2.sceneNode), t2.children[e2.index] = e2;
    })) : (this.root = i2, this.add(n2)), i2;
  }
  updateVisibleBounds() {
    const e2 = this.visibleBounds;
    e2.min.set(1 / 0, 1 / 0, 1 / 0), e2.max.set(-1 / 0, -1 / 0, -1 / 0);
    for (const t2 of this.visibleNodes)
      t2.isLeafNode && (e2.expandByPoint(t2.boundingBox.min), e2.expandByPoint(t2.boundingBox.max));
  }
  updateBoundingBoxes() {
    if (!this.showBoundingBox || !this.parent)
      return;
    let e2 = this.parent.getObjectByName("bbroot");
    e2 || (e2 = new o.Object3D(), e2.name = "bbroot", this.parent.add(e2));
    const t2 = [];
    for (const e3 of this.visibleNodes)
      void 0 !== e3.boundingBoxNode && e3.isLeafNode && t2.push(e3.boundingBoxNode);
    e2.children = t2;
  }
  updateMatrixWorld(e2) {
    true === this.matrixAutoUpdate && this.updateMatrix(), true !== this.matrixWorldNeedsUpdate && true !== e2 || (this.parent ? this.matrixWorld.multiplyMatrices(this.parent.matrixWorld, this.matrix) : this.matrixWorld.copy(this.matrix), this.matrixWorldNeedsUpdate = false, e2 = true);
  }
  hideDescendants(e2) {
    const t2 = [];
    for (n2(e2); t2.length > 0; ) {
      const e3 = t2.shift();
      e3.visible = false, n2(e3);
    }
    function n2(e3) {
      for (const n3 of e3.children)
        n3.visible && t2.push(n3);
    }
  }
  moveToOrigin() {
    this.position.set(0, 0, 0), this.position.set(0, 0, 0).sub(this.getBoundingBoxWorld().getCenter(new o.Vector3()));
  }
  moveToGroundPlane() {
    this.position.y += -this.getBoundingBoxWorld().min.y;
  }
  getBoundingBoxWorld() {
    return this.updateMatrixWorld(true), ne(this.boundingBox, this.matrixWorld);
  }
  getVisibleExtent() {
    return this.visibleBounds.applyMatrix4(this.matrixWorld);
  }
  pick(e2, t2, n2, i2 = {}) {
    return this.picker = this.picker || new le(), this.picker.pick(e2, t2, n2, [this], i2);
  }
  get progress() {
    return 0 === this.visibleGeometry.length ? 0 : this.visibleNodes.length / this.visibleGeometry.length;
  }
};
var fe = { DATA_TYPE_DOUBLE: { ordinal: 0, name: "double", size: 8 }, DATA_TYPE_FLOAT: { ordinal: 1, name: "float", size: 4 }, DATA_TYPE_INT8: { ordinal: 2, name: "int8", size: 1 }, DATA_TYPE_UINT8: { ordinal: 3, name: "uint8", size: 1 }, DATA_TYPE_INT16: { ordinal: 4, name: "int16", size: 2 }, DATA_TYPE_UINT16: { ordinal: 5, name: "uint16", size: 2 }, DATA_TYPE_INT32: { ordinal: 6, name: "int32", size: 4 }, DATA_TYPE_UINT32: { ordinal: 7, name: "uint32", size: 4 }, DATA_TYPE_INT64: { ordinal: 8, name: "int64", size: 8 }, DATA_TYPE_UINT64: { ordinal: 9, name: "uint64", size: 8 } };
var ue = 0;
for (let e2 in fe)
  fe[ue] = fe[e2], ue++;
var pe = class {
  constructor(e2, t2, n2, i2 = [1 / 0, -1 / 0]) {
    this.name = e2, this.type = t2, this.numElements = n2, this.range = i2, this.byteSize = this.numElements * this.type.size, this.description = "";
  }
};
var me = { POSITION_CARTESIAN: new pe("POSITION_CARTESIAN", fe.DATA_TYPE_FLOAT, 3), RGBA_PACKED: new pe("COLOR_PACKED", fe.DATA_TYPE_INT8, 4), COLOR_PACKED: new pe("COLOR_PACKED", fe.DATA_TYPE_INT8, 4), RGB_PACKED: new pe("COLOR_PACKED", fe.DATA_TYPE_INT8, 3), NORMAL_FLOATS: new pe("NORMAL_FLOATS", fe.DATA_TYPE_FLOAT, 3), INTENSITY: new pe("INTENSITY", fe.DATA_TYPE_UINT16, 1), CLASSIFICATION: new pe("CLASSIFICATION", fe.DATA_TYPE_UINT8, 1), NORMAL_SPHEREMAPPED: new pe("NORMAL_SPHEREMAPPED", fe.DATA_TYPE_UINT8, 2), NORMAL_OCT16: new pe("NORMAL_OCT16", fe.DATA_TYPE_UINT8, 2), NORMAL: new pe("NORMAL", fe.DATA_TYPE_FLOAT, 3), RETURN_NUMBER: new pe("RETURN_NUMBER", fe.DATA_TYPE_UINT8, 1), NUMBER_OF_RETURNS: new pe("NUMBER_OF_RETURNS", fe.DATA_TYPE_UINT8, 1), SOURCE_ID: new pe("SOURCE_ID", fe.DATA_TYPE_UINT16, 1), INDICES: new pe("INDICES", fe.DATA_TYPE_UINT32, 1), SPACING: new pe("SPACING", fe.DATA_TYPE_FLOAT, 1), GPS_TIME: new pe("GPS_TIME", fe.DATA_TYPE_DOUBLE, 1) };
var ge = class {
  constructor(e2, t2 = [], n2 = 0, i2 = 0, r2 = []) {
    if (this.attributes = t2, this.byteSize = n2, this.size = i2, this.vectors = r2, null != e2)
      for (let t3 = 0; t3 < e2.length; t3++) {
        let n3 = e2[t3], i3 = me[n3];
        this.attributes.push(i3), this.byteSize += i3.byteSize, this.size++;
      }
  }
  add(e2) {
    this.attributes.push(e2), this.byteSize += e2.byteSize, this.size++;
  ...
  addVector(e2) {
    this.vectors.push(e2);
  }
  hasNormals() {
    for (let e2 in this.attributes) {
      let t2 = this.attributes[e2];
      if (t2 === me.NORMAL_SPHEREMAPPED || t2 === me.NORMAL_FLOATS || t2 === me.NORMAL || t2 === me.NORMAL_OCT16)
        return true;
    }
    return false;
  }
...
var ve;
!function(e2) {
  e2.DECODER_WORKER_BROTLI = "DECODER_WORKER_BROTLI", e2.DECODER_WORKER = "DECODER_WORKER";
}(ve || (ve = {}));
var ye = class {
  constructor() {
  ...
  getWorker(e2) {
    if (void 0 === this.workers[e2])
      throw new Error("Unknown worker type");
    if (0 === this.workers[e2].length) {
      let t3 = function(e3) {
        switch (e3) {
          case ve.DECODER_WORKER_BROTLI:
            return new Pe();
          case ve.DECODER_WORKER:
            return new be();
          default:
            throw new Error("Unknown worker type");
        }
      }(e2);
      this.workers[e2].push(t3);
    }
    let t2 = this.workers[e2].pop();
    if (void 0 === t2)
      throw new Error("No workers available");
    return t2;
  }
  returnWorker(e2, t2) {
    this.workers[e2].push(t2);
  }
};
var $e = class _$e {
  constructor(e2, t2, n2) {
    this.name = e2, this.octreeGeometry = t2, this.boundingBox = n2, this.loaded = false, this.loading = false, this.parent = null, this.geometry = null, this.hasChildren = false, this.isLeafNode = true, this.isTreeNode = false, this.isGeometryNode = true, this.children = [null, null, null, null, null, null, null, null], this.id = _$e.IDCount++, this.index = parseInt(e2.charAt(e2.length - 1)), this.boundingSphere = n2.getBoundingSphere(new o.Sphere()), this.numPoints = 0, this.oneTimeDisposeHandlers = [];
  }
  getLevel() {
    return this.level;
  }
  ...
  dispose() {
    if (this.geometry && null != this.parent) {
      this.geometry.dispose(), this.geometry = null, this.loaded = false;
      for (let e2 = 0; e2 < this.oneTimeDisposeHandlers.length; e2++)
        (0, this.oneTimeDisposeHandlers[e2])();
...
$e.IDCount = 0, $e.IDCount = 0;
var we = class {
  constructor(e2, t2, n2) {
    this.url = e2, this.workerPool = t2, this.metadata = n2;
  }
  async load(e2) {
    if (!e2.loaded && !e2.loading) {
      e2.loading = true, e2.octreeGeometry.numNodesLoading++;
      try {
        2 === e2.nodeType && await this.loadHierarchy(e2);
        let { byteOffset: t2, byteSize: n2 } = e2;
        if (void 0 === t2 || void 0 === n2)
          throw new Error("byteOffset and byteSize are required");
        let i2, r2 = this.url.replace("/metadata.json", "/octree.bin"), a2 = t2, s2 = t2 + n2 - BigInt(1);
        if (n2 === BigInt(0))
          i2 = new ArrayBuffer(0), console.warn(`loaded node with 0 bytes: ${e2.name}`);
        else {
          let e3 = await fetch(r2, { headers: { "content-type": "multipart/byteranges", Range: `bytes=${a2}-${s2}` } });
          i2 = await e3.arrayBuffer();
        }
        const l2 = "BROTLI" === this.metadata.encoding ? ve.DECODER_WORKER_BROTLI : ve.DECODER_WORKER, c2 = this.workerPool.getWorker(l2);
        c2.onmessage = (t3) => {
          let n3 = t3.data, i3 = n3.attributeBuffers;
          this.workerPool.returnWorker(l2, c2);
          let r3 = new o.BufferGeometry();
          for (let e3 in i3) {
            let t4 = i3[e3].buffer;
            if ("position" === e3)
              r3.setAttribute("position", new o.BufferAttribute(new Float32Array(t4), 3));
            else if ("rgba" === e3)
              r3.setAttribute("rgba", new o.BufferAttribute(new Uint8Array(t4), 4, true));
            else if ("NORMAL" === e3)
              r3.setAttribute("normal", new o.BufferAttribute(new Float32Array(t4), 3));
            else if ("INDICES" === e3) {
              let e4 = new o.BufferAttribute(new Uint8Array(t4), 4);
              e4.normalized = true, r3.setAttribute("indices", e4);
            } else {
              const n4 = new o.BufferAttribute(new Float32Array(t4), 1);
              let a3 = i3[e3].attribute;
              n4.potree = { offset: i3[e3].offset, scale: i3[e3].scale, preciseBuffer: i3[e3].preciseBuffer, range: a3.range }, r3.setAttribute(e3, n4);
            }
          }
          e2.density = n3.density, e2.geometry = r3, e2.loaded = true, e2.loading = false, e2.octreeGeometry.numNodesLoading--;
        };
        let d2 = e2.octreeGeometry.pointAttributes, h2 = e2.octreeGeometry.scale, f2 = e2.boundingBox, u2 = e2.octreeGeometry.offset.clone().add(f2.min), p2 = f2.max.clone().sub(f2.min), m2 = u2.clone().add(p2), g2 = e2.numPoints, P2 = e2.octreeGeometry.loader.offset, b2 = { name: e2.name, buffer: i2, pointAttributes: d2, scale: h2, min: u2, max: m2, size: p2, offset: P2, numPoints: g2 };
        c2.postMessage(b2, [b2.buffer]);
      } catch (t2) {
        e2.loaded = false, e2.loading = false, e2.octreeGeometry.numNodesLoading--;
      }
    }
  }
  parseHierarchy(e2, t2) {
    let n2 = new DataView(t2), i2 = 22, r2 = t2.byteLength / i2, o2 = e2.octreeGeometry, a2 = new Array(r2);
    a2[0] = e2;
    let s2 = 1;
    for (let e3 = 0; e3 < r2; e3++) {
      let t3 = a2[e3], r3 = n2.getUint8(e3 * i2 + 0), l2 = n2.getUint8(e3 * i2 + 1), c2 = n2.getUint32(e3 * i2 + 2, true), d2 = n2.getBigInt64(e3 * i2 + 6, true), h2 = n2.getBigInt64(e3 * i2 + 14, true);
      if (2 === t3.nodeType ? (t3.byteOffset = d2, t3.byteSize = h2, t3.numPoints = c2) : 2 === r3 ? (t3.hierarchyByteOffset = d2, t3.hierarchyByteSize = h2, t3.numPoints = c2) : (t3.byteOffset = d2, t3.byteSize = h2, t3.numPoints = c2), t3.nodeType = r3, 2 !== t3.nodeType)
        for (let e4 = 0; e4 < 8; e4++) {
          if (!(1 << e4 & l2))
            continue;
          let n3 = t3.name + e4, i3 = xe(t3.boundingBox, e4), r4 = new $e(n3, o2, i3);
          r4.name = n3, r4.spacing = t3.spacing / 2, r4.level = t3.level + 1, t3.children[e4] = r4, r4.parent = t3, a2[s2] = r4, s2++;
        }
    }
  }
  async loadHierarchy(e2) {
    let { hierarchyByteOffset: t2, hierarchyByteSize: n2 } = e2;
    if (void 0 === t2 || void 0 === n2)
      throw new Error(`hierarchyByteOffset and hierarchyByteSize are undefined for node ${e2.name}`);
    let i2 = this.url.replace("/metadata.json", "/hierarchy.bin"), r2 = t2, o2 = r2 + n2 - BigInt(1), a2 = await fetch(i2, { headers: { "content-type": "multipart/byteranges", Range: `bytes=${r2}-${o2}` } }), s2 = await a2.arrayBuffer();
    this.parseHierarchy(e2, s2);
  }
};
var Xe = new o.Vector3();
function xe(e2, t2) {
  let n2 = e2.min.clone(), i2 = e2.max.clone(), r2 = Xe.subVectors(i2, n2);
  return (1 & t2) > 0 ? n2.z += r2.z / 2 : i2.z -= r2.z / 2, (2 & t2) > 0 ? n2.y += r2.y / 2 : i2.y -= r2.y / 2, (4 & t2) > 0 ? n2.x += r2.x / 2 : i2.x -= r2.x / 2, new o.Box3(n2, i2);
}
var Ye = { double: fe.DATA_TYPE_DOUBLE, float: fe.DATA_TYPE_FLOAT, int8: fe.DATA_TYPE_INT8, uint8: fe.DATA_TYPE_UINT8, int16: fe.DATA_TYPE_INT16, uint16: fe.DATA_TYPE_UINT16, int32: fe.DATA_TYPE_INT32, uint32: fe.DATA_TYPE_UINT32, int64: fe.DATA_TYPE_INT64, uint64: fe.DATA_TYPE_UINT64 };
var Ae = class _Ae {
  constructor() {
    this.workerPool = new ye();
  }
  static parseAttributes(e2) {
    let t2 = new ge(), n2 = { rgb: "rgba" };
    for (const i2 of e2) {
      let { name: e3, numElements: r2, min: o2, max: a2 } = i2, s2 = Ye[i2.type], l2 = new pe(n2[e3] ? n2[e3] : e3, s2, r2);
      l2.range = 1 === r2 ? [o2[0], a2[0]] : [o2, a2], "gps-time" === e3 && "number" == typeof l2.range[0] && l2.range[0] === l2.range[1] && (l2.range[1] += 1), l2.initialRange = l2.range, t2.add(l2);
    }
    if (void 0 !== t2.attributes.find((e3) => "NormalX" === e3.name) && void 0 !== t2.attributes.find((e3) => "NormalY" === e3.name) && void 0 !== t2.attributes.find((e3) => "NormalZ" === e3.name)) {
      let e3 = { name: "NORMAL", attributes: ["NormalX", "NormalY", "NormalZ"] };
      t2.addVector(e3);
    }
    return t2;
  }
  async load(e2, t2) {
    let n2 = await t2(e2), i2 = await n2.json(), r2 = _Ae.parseAttributes(i2.attributes), a2 = new we(e2, this.workerPool, i2);
    a2.attributes = r2, a2.scale = i2.scale, a2.offset = i2.offset;
    let s2 = new ce(a2, new o.Box3(new o.Vector3(...i2.boundingBox.min), new o.Vector3(...i2.boundingBox.max)));
    s2.url = e2, s2.spacing = i2.spacing, s2.scale = i2.scale;
    let l2 = new o.Vector3(...i2.boundingBox.min), c2 = new o.Vector3(...i2.boundingBox.max), d2 = new o.Box3(l2, c2), h2 = l2.clone();
    d2.min.sub(h2), d2.max.sub(h2), s2.projection = i2.projection, s2.boundingBox = d2, s2.tightBoundingBox = d2.clone(), s2.boundingSphere = d2.getBoundingSphere(new o.Sphere()), s2.tightBoundingSphere = d2.getBoundingSphere(new o.Sphere()), s2.offset = h2, s2.pointAttributes = _Ae.parseAttributes(i2.attributes);
    let f2 = new $e("r", s2, d2);
    return f2.level = 0, f2.nodeType = 2, f2.hierarchyByteOffset = BigInt(0), f2.hierarchyByteSize = BigInt(i2.hierarchy.firstChunkSize), f2.spacing = s2.spacing, f2.byteOffset = BigInt(0), s2.root = f2, a2.load(f2), { geometry: s2 };
  }
};
var Te = null;
function Ce() {
  ...
  return Te = e2.getContext("webgl"), Te;
}
function Qe(e2) {
  const t2 = Ce();
  return null !== t2 && Boolean(t2.getExtension(e2));
}
function _e(e2) {
  const t2 = Ce();
  return null !== t2 && t2.getParameter(t2.MAX_VARYING_VECTORS) >= e2;
}
function Ie() {
  const e2 = Ce();
  if (null === e2)
    return "";
  const t2 = e2.getShaderPrecisionFormat(e2.VERTEX_SHADER, e2.HIGH_FLOAT), n2 = e2.getShaderPrecisionFormat(e2.VERTEX_SHADER, e2.MEDIUM_FLOAT), i2 = e2.getShaderPrecisionFormat(e2.FRAGMENT_SHADER, e2.HIGH_FLOAT), r2 = e2.getShaderPrecisionFormat(e2.FRAGMENT_SHADER, e2.MEDIUM_FLOAT), o2 = t2 && i2 && t2.precision > 0 && i2.precision > 0, a2 = n2 && r2 && n2.precision > 0 && r2.precision > 0;
  return o2 ? "highp" : a2 ? "mediump" : "lowp";
}
var Se = class _Se {
  constructor(e2) {
    this.versionMinor = 0, this.version = e2;
    const t2 = -1 === e2.indexOf(".") ? e2.length : e2.indexOf(".");
    this.versionMajor = parseInt(e2.substr(0, t2), 10), this.versionMinor = parseInt(e2.substr(t2 + 1), 10), isNaN(this.versionMinor) && (this.versionMinor = 0);
  }
  newerThan(e2) {
    const t2 = new _Se(e2);
    return this.versionMajor > t2.versionMajor || this.versionMajor === t2.versionMajor && this.versionMinor > t2.versionMinor;
  }
  equalOrHigher(e2) {
    const t2 = new _Se(e2);
    return this.versionMajor > t2.versionMajor || this.versionMajor === t2.versionMajor && this.versionMinor >= t2.versionMinor;
  ...
  upTo(e2) {
    return !this.newerThan(e2);
  }
};
var Oe = i(318).A;
var Be = class {
  constructor({ getUrl: e2 = (e3) => Promise.resolve(e3), version: t2, boundingBox: n2, scale: i2, xhrRequest: r2 }) {
    this.disposed = false, this.workers = [], this.version = "string" == typeof t2 ? new Se(t2) : t2, this.xhrRequest = r2, this.getUrl = e2, this.boundingBox = n2, this.scale = i2, this.callbacks = [];
  }
  dispose() {
    this.workers.forEach((e2) => e2.terminate()), this.workers = [], this.disposed = true;
  }
  load(e2) {
    return e2.loaded || this.disposed ? Promise.resolve() : Promise.resolve(this.getUrl(this.getNodeUrl(e2))).then((e3) => this.xhrRequest(e3, { mode: "cors" })).then((e3) => e3.arrayBuffer()).then((t2) => new Promise((n2) => this.parse(e2, t2, n2)));
  }
  getNodeUrl(e2) {
    let t2 = e2.getUrl();
    return this.version.equalOrHigher("1.4") && (t2 += ".bin"), t2;
  }
  parse(e2, t2, n2) {
    if (this.disposed)
      return void n2();
    const i2 = this.getWorker(), r2 = e2.pcoGeometry.pointAttributes, a2 = t2.byteLength / r2.byteSize;
    this.version.upTo("1.5") && (e2.numPoints = a2), i2.onmessage = (t3) => {
      if (this.disposed)
        return void n2();
      const r3 = t3.data, s3 = e2.geometry = e2.geometry || new o.BufferGeometry();
      s3.boundingBox = e2.boundingBox, this.addBufferAttributes(s3, r3.attributeBuffers), this.addIndices(s3, r3.indices), this.addNormalAttribute(s3, a2), e2.mean = new o.Vector3().fromArray(r3.mean), e2.tightBoundingBox = this.getTightBoundingBox(r3.tightBoundingBox), e2.loaded = true, e2.loading = false, e2.failed = false, e2.pcoGeometry.numNodesLoading--, e2.pcoGeometry.needsUpdate = true, this.releaseWorker(i2), this.callbacks.forEach((t4) => t4(e2)), n2();
    };
    const s2 = { buffer: t2, pointAttributes: r2, version: this.version.version, min: e2.boundingBox.min.toArray(), offset: e2.pcoGeometry.offset.toArray(), scale: this.scale, spacing: e2.spacing, hasChildren: e2.hasChildren };
    i2.postMessage(s2, [s2.buffer]);
  }
  getWorker() {
    return this.workers.pop() || new Oe();
  }
  releaseWorker(e2) {
    this.workers.push(e2);
  }
  getTightBoundingBox({ min: e2, max: t2 }) {
    const n2 = new o.Box3(new o.Vector3().fromArray(e2), new o.Vector3().fromArray(t2));
    return n2.max.sub(n2.min), n2.min.set(0, 0, 0), n2;
  }
  addBufferAttributes(e2, t2) {
    Object.keys(t2).forEach((n2) => {
      const i2 = t2[n2].buffer;
      this.isAttribute(n2, q.POSITION_CARTESIAN) ? e2.setAttribute("position", new o.BufferAttribute(new Float32Array(i2), 3)) : this.isAttribute(n2, q.COLOR_PACKED) ? e2.setAttribute("color", new o.BufferAttribute(new Uint8Array(i2), 3, true)) : this.isAttribute(n2, q.INTENSITY) ? e2.setAttribute("intensity", new o.BufferAttribute(new Float32Array(i2), 1)) : this.isAttribute(n2, q.CLASSIFICATION) ? e2.setAttribute("classification", new o.BufferAttribute(new Uint8Array(i2), 1)) : (this.isAttribute(n2, q.NORMAL_SPHEREMAPPED) || this.isAttribute(n2, q.NORMAL_OCT16) || this.isAttribute(n2, q.NORMAL)) && e2.setAttribute("normal", new o.BufferAttribute(new Float32Array(i2), 3));
    });
  }
  addIndices(e2, t2) {
    const n2 = new o.Uint8BufferAttribute(t2, 4);
    n2.normalized = true, e2.setAttribute("indices", n2);
  }
  addNormalAttribute(e2, t2) {
    if (!e2.getAttribute("normal")) {
      const n2 = new Float32Array(3 * t2);
      e2.setAttribute("normal", new o.BufferAttribute(new Float32Array(n2), 3));
    }
  }
  isAttribute(e2, t2) {
    return parseInt(e2, 10) === t2;
  }
};
function Ne(e2) {
  return { index: b(e2), parentName: e2.substring(0, e2.length - 1), level: e2.length - 1 };
}
function ke(e2) {
  return null != e2 && e2.isGeometryNode;
}
function Ee(e2) {
  return null != e2 && e2.isTreeNode;
}
function De(e2) {
  this.content = [], this.scoreFunction = e2;
}
De.prototype = { push: function(e2) {
  this.content.push(e2), this.bubbleUp(this.content.length - 1);
}, pop: function() {
  var e2 = this.content[0], t2 = this.content.pop();
  return this.content.length > 0 && (this.content[0] = t2, this.sinkDown(0)), e2;
}, remove: function(e2) {
  for (var t2 = this.content.length, n2 = 0; n2 < t2; n2++)
    if (this.content[n2] === e2) {
      var i2 = this.content.pop();
      if (n2 === t2 - 1)
        break;
      this.content[n2] = i2, this.bubbleUp(n2), this.sinkDown(n2);
      break;
    }
}, size: function() {
  return this.content.length;
}, bubbleUp: function(e2) {
  for (var t2 = this.content[e2], n2 = this.scoreFunction(t2); e2 > 0; ) {
    var i2 = Math.floor((e2 + 1) / 2) - 1, r2 = this.content[i2];
    if (n2 >= this.scoreFunction(r2))
      break;
    this.content[i2] = t2, this.content[e2] = r2, e2 = i2;
  }
}, sinkDown: function(e2) {
  for (var t2 = this.content.length, n2 = this.content[e2], i2 = this.scoreFunction(n2); ; ) {
    var r2 = 2 * (e2 + 1), o2 = r2 - 1, a2 = null;
    if (o2 < t2) {
      var s2 = this.content[o2], l2 = this.scoreFunction(s2);
      l2 < i2 && (a2 = o2);
    }
    if (r2 < t2) {
      var c2 = this.content[r2];
      this.scoreFunction(c2) < (null == a2 ? i2 : l2) && (a2 = r2);
    }
    if (null == a2)
      break;
    this.content[e2] = this.content[a2], this.content[a2] = n2, e2 = a2;
  }
} };
var Le = class extends o.LineSegments {
  constructor(e2, t2 = new o.Color(16776960)) {
    const n2 = new Uint16Array([0, 1, 1, 2, 2, 3, 3, 0, 4, 5, 5, 6, 6, 7, 7, 4, 0, 4, 1, 5, 2, 6, 3, 7]), i2 = new Float32Array([e2.min.x, e2.min.y, e2.min.z, e2.max.x, e2.min.y, e2.min.z, e2.max.x, e2.min.y, e2.max.z, e2.min.x, e2.min.y, e2.max.z, e2.min.x, e2.max.y, e2.min.z, e2.max.x, e2.max.y, e2.min.z, e2.max.x, e2.max.y, e2.max.z, e2.min.x, e2.max.y, e2.max.z]), r2 = new o.BufferGeometry();
    r2.setIndex(new o.BufferAttribute(n2, 1)), r2.setAttribute("position", new o.BufferAttribute(i2, 3)), super(r2, new o.LineBasicMaterial({ color: t2 }));
  }
};
var Re = class {
  constructor(e2) {
    this.node = e2, this.next = null, this.previous = null;
  }
};
var ze = class {
  constructor(e2 = 1e6) {
    this.pointBudget = e2, this.first = null, this.last = null, this.numPoints = 0, this.items = /* @__PURE__ */ new Map();
  }
  get size() {
    return this.items.size;
  }
  has(e2) {
    return this.items.has(e2.id);
  }
  touch(e2) {
    if (!e2.loaded)
      return;
    const t2 = this.items.get(e2.id);
    t2 ? this.touchExisting(t2) : this.addNew(e2);
  }
  addNew(e2) {
    const t2 = new Re(e2);
    t2.previous = this.last, this.last = t2, t2.previous && (t2.previous.next = t2), this.first || (this.first = t2), this.items.set(e2.id, t2), this.numPoints += e2.numPoints;
  }
  touchExisting(e2) {
    e2.previous ? e2.next && (e2.previous.next = e2.next, e2.next.previous = e2.previous, e2.previous = this.last, e2.next = null, this.last = e2, e2.previous && (e2.previous.next = e2)) : e2.next && (this.first = e2.next, this.first.previous = null, e2.previous = this.last, e2.next = null, this.last = e2, e2.previous && (e2.previous.next = e2));
  }
  remove(e2) {
    const t2 = this.items.get(e2.id);
    t2 && (1 === this.items.size ? (this.first = null, this.last = null) : (t2.previous || (this.first = t2.next, this.first.previous = null), t2.next || (this.last = t2.previous, this.last.next = null), t2.previous && t2.next && (t2.previous.next = t2.next, t2.next.previous = t2.previous)), this.items.delete(e2.id), this.numPoints -= e2.numPoints);
  }
  getLRUItem() {
  ...
  freeMemory() {
    if (!(this.items.size <= 1))
      for (; this.numPoints > 2 * this.pointBudget; ) {
        const e2 = this.getLRUItem();
        e2 && this.disposeSubtree(e2);
      }
  }
  disposeSubtree(e2) {
    const t2 = [e2];
    e2.traverse((e3) => {
      e3.loaded && t2.push(e3);
    });
    for (const e3 of t2)
      e3.dispose(), this.remove(e3);
  }
};
var Me = class {
  constructor(e2, t2, n2, i2) {
    this.pointCloudIndex = e2, this.weight = t2, this.node = n2, this.parent = i2;
  }
};
var Ue = class _Ue {
  constructor() {
    this._pointBudget = 1e6, this._rendererSize = new o.Vector2(), this.maxNumNodesLoading = 4, this.lru = new ze(this._pointBudget), this.updateVisibilityStructures = (() => {
      const e2 = new o.Matrix4(), t2 = new o.Matrix4(), n2 = new o.Matrix4();
      return (i2, r2) => {
        var _a;
        const a2 = [], s2 = [], l2 = new De((e3) => 1 / e3.weight);
        for (let c2 = 0; c2 < i2.length; c2++) {
          const d2 = i2[c2];
          if (!d2.initialized())
            continue;
          d2.numVisiblePoints = 0, d2.visibleNodes = [], d2.visibleGeometry = [], r2.updateMatrixWorld(false);
          const h2 = r2.matrixWorldInverse, f2 = d2.matrixWorld;
          if (e2.identity().multiply(r2.projectionMatrix).multiply(h2).multiply(f2), a2.push(new o.Frustum().setFromProjectionMatrix(e2)), t2.copy(f2).invert(), n2.identity().multiply(t2).multiply(r2.matrixWorld), s2.push(new o.Vector3().setFromMatrixPosition(n2)), d2.visible && null !== d2.root) {
            const e3 = Number.MAX_VALUE;
            l2.push(new Me(c2, e3, d2.root));
          }
          Ee(d2.root) && d2.hideDescendants((_a = d2 == null ? void 0 : d2.root) == null ? void 0 : _a.sceneNode);
          for (const e3 of d2.boundingBoxNodes)
            e3.visible = false;
        }
        return { frustums: a2, cameraPositions: s2, priorityQueue: l2 };
      };
    })();
  }
  get features() {
    return { SHADER_INTERPOLATION: Qe("EXT_frag_depth") && _e(8), SHADER_SPLATS: Qe("EXT_frag_depth") && Qe("OES_texture_float") && _e(8), SHADER_EDL: Qe("OES_texture_float") && _e(8), precision: Ie() };
  }
  async loadPointCloud(e2, t2, n2 = (e3, t3) => fetch(e3, t3)) {
    if ("cloud.js" === e2)
      return await function(e3, t3, n3) {
        return Promise.resolve(t3(e3)).then((e4) => n3(e4, { mode: "cors" }).then((e5) => e5.json()).then(function(e5, t4, n4) {
          return (i2) => {
            const { offset: r2, boundingBox: a2, tightBoundingBox: s2 } = function(e6) {
              const t5 = new o.Vector3(e6.boundingBox.lx, e6.boundingBox.ly, e6.boundingBox.lz), n5 = new o.Vector3(e6.boundingBox.ux, e6.boundingBox.uy, e6.boundingBox.uz), i3 = new o.Box3(t5, n5), r3 = i3.clone(), a3 = t5.clone();
              if (e6.tightBoundingBox) {
                const { lx: t6, ly: n6, lz: i4, ux: o2, uy: a4, uz: s3 } = e6.tightBoundingBox;
                r3.min.set(t6, n6, i4), r3.max.set(o2, a4, s3);
              }
              return i3.min.sub(a3), i3.max.sub(a3), r3.min.sub(a3), r3.max.sub(a3), { offset: a3, boundingBox: i3, tightBoundingBox: r3 };
            }(i2), l2 = new Be({ getUrl: t4, version: i2.version, boundingBox: a2, scale: i2.scale, xhrRequest: n4 }), c2 = new oe(l2, a2, s2, r2, n4);
            c2.url = e5, c2.octreeDir = i2.octreeDir, c2.needsUpdate = true, c2.spacing = i2.spacing, c2.hierarchyStepSize = i2.hierarchyStepSize, c2.projection = i2.projection, c2.offset = r2, c2.pointAttributes = new Z(i2.pointAttributes);
            const d2 = {}, h2 = new Se(i2.version);
            return function(e6, t5, n5, i3) {
              const r3 = new re("r", e6, e6.boundingBox);
              return r3.hasChildren = true, r3.spacing = e6.spacing, i3.upTo("1.5") ? r3.numPoints = t5.hierarchy[0][1] : r3.numPoints = 0, e6.root = r3, n5.r = r3, e6.root.load();
            }(c2, i2, d2, h2).then(() => (h2.upTo("1.4") && function(e6, t5, n5) {
              for (let i3 = 1; i3 < t5.hierarchy.length; i3++) {
                const [r3, o2] = t5.hierarchy[i3], { index: a3, parentName: s3, level: l3 } = Ne(r3), c3 = n5[s3], d3 = ie(c3.boundingBox, a3), h3 = new re(r3, e6, d3);
                h3.level = l3, h3.numPoints = o2, h3.spacing = e6.spacing / Math.pow(2, h3.level), n5[r3] = h3, c3.addChild(h3);
              }
            }(c2, i2, d2), c2.nodes = d2, c2));
          };
        }(e4, t3, n3)));
      }(e2, t2, n2).then((e3) => new he(this, e3));
    if ("metadata.json" === e2)
      return await async function(e3, t3, n3) {
        const i2 = await t3(e3), r2 = new Ae(), { geometry: o2 } = await r2.load(i2, n3);
        return o2;
      }(e2, t2, n2).then((e3) => new he(this, e3));
    throw new Error("Unsupported file type");
  }
  updatePointClouds(e2, t2, n2) {
    const i2 = this.updateVisibility(e2, t2, n2);
    for (let i3 = 0; i3 < e2.length; i3++) {
      const r2 = e2[i3];
      r2.disposed || (r2.material.updateMaterial(r2, r2.visibleNodes, t2, n2), r2.updateVisibleBounds(), r2.updateBoundingBoxes());
    }
    return this.lru.freeMemory(), i2;
  }
  static pick(e2, t2, n2, i2, r2 = {}) {
    return _Ue.picker = _Ue.picker || new le(), _Ue.picker.pick(t2, n2, i2, e2, r2);
  }
  get pointBudget() {
    return this._pointBudget;
  }
  set pointBudget(e2) {
    e2 !== this._pointBudget && (this._pointBudget = e2, this.lru.pointBudget = e2, this.lru.freeMemory());
  }
  updateVisibility(e2, t2, n2) {
    let i2 = 0;
    const r2 = [], o2 = [], { frustums: a2, cameraPositions: s2, priorityQueue: l2 } = this.updateVisibilityStructures(e2, t2);
    let c2, d2 = 0, h2 = false, f2 = false;
    for (; void 0 !== (c2 = l2.pop()); ) {
      let u3 = c2.node;
      if (i2 + u3.numPoints > this.pointBudget)
        break;
      const p3 = c2.pointCloudIndex, m2 = e2[p3], g2 = void 0 !== m2.maxLevel ? m2.maxLevel : 1 / 0;
      if (u3.level > g2 || !a2[p3].intersectsBox(u3.boundingBox) || this.shouldClip(m2, u3.boundingBox))
        continue;
      i2 += u3.numPoints, m2.numVisiblePoints += u3.numPoints;
      const P2 = c2.parent;
      if (ke(u3) && (!P2 || Ee(P2)))
        if (u3.loaded && d2 < 2)
          u3 = m2.toTreeNode(u3, P2), d2++;
        else {
          if (u3.failed) {
            f2 = true;
            continue;
          }
          u3.loaded && d2 >= 2 && (h2 = true), o2.push(u3), m2.visibleGeometry.push(u3);
        }
      Ee(u3) && (this.updateTreeNodeVisibility(m2, u3, r2), m2.visibleGeometry.push(u3.geometryNode));
      const b2 = 0.5 * n2.getSize(this._rendererSize).height * n2.getPixelRatio();
      this.updateChildVisibility(c2, l2, m2, u3, s2[p3], t2, b2);
    }
    const u2 = Math.min(this.maxNumNodesLoading, o2.length), p2 = [];
    for (let e3 = 0; e3 < u2; e3++)
      p2.push(o2[e3].load());
    return { visibleNodes: r2, numVisiblePoints: i2, exceededMaxLoadsToGPU: h2, nodeLoadFailed: f2, nodeLoadPromises: p2 };
  }
  updateTreeNodeVisibility(e2, t2, n2) {
    this.lru.touch(t2.geometryNode);
    const i2 = t2.sceneNode;
    i2.visible = true, i2.material = e2.material, i2.updateMatrix(), i2.matrixWorld.multiplyMatrices(e2.matrixWorld, i2.matrix), n2.push(t2), e2.visibleNodes.push(t2), this.updateBoundingBoxVisibility(e2, t2);
  }
  updateChildVisibility(e2, t2, n2, i2, r2, o2, a2) {
    const s2 = i2.children;
    for (let l2 = 0; l2 < s2.length; l2++) {
      const c2 = s2[l2];
      if (null === c2)
        continue;
      const d2 = c2.boundingSphere, h2 = d2.center.distanceTo(r2), f2 = d2.radius;
      let u2, p2, g2 = 0;
      if (o2.type === m) {
        const e3 = o2.fov * Math.PI / 180;
        g2 = a2 / (Math.tan(e3 / 2) * h2), p2 = f2 * g2, u2 = h2 < f2 ? Number.MAX_VALUE : p2 + 1 / h2;
      } else {
        const e3 = o2;
        g2 = 2 * a2 / (e3.top - e3.bottom) * e3.zoom, p2 = f2 * g2, u2 = p2;
      }
      p2 < n2.minNodePixelSize || t2.push(new Me(e2.pointCloudIndex, u2, c2, i2));
    }
  }
  updateBoundingBoxVisibility(e2, t2) {
    if (e2.showBoundingBox && !t2.boundingBoxNode) {
      const n2 = new Le(t2.boundingBox);
      n2.matrixAutoUpdate = false, e2.boundingBoxNodes.push(n2), t2.boundingBoxNode = n2, t2.boundingBoxNode.matrix.copy(e2.matrixWorld);
    } else
      e2.showBoundingBox && t2.boundingBoxNode ? (t2.boundingBoxNode.visible = true, t2.boundingBoxNode.matrix.copy(e2.matrixWorld)) : !e2.showBoundingBox && t2.boundingBoxNode && (t2.boundingBoxNode.visible = false);
  }
  shouldClip(e2, t2) {
    const n2 = e2.material;
    if (0 === n2.numClipBoxes || n2.clipMode !== l.CLIP_OUTSIDE)
      return false;
    const i2 = t2.clone();
    e2.updateMatrixWorld(true), i2.applyMatrix4(e2.matrixWorld);
    const r2 = n2.clipBoxes;
    for (let e3 = 0; e3 < r2.length; e3++) {
      const t3 = r2[e3].matrix, n3 = new o.Box3(new o.Vector3(-0.5, -0.5, -0.5), new o.Vector3(0.5, 0.5, 0.5)).applyMatrix4(t3);
      if (i2.intersectsBox(n3))
        return false;
    }
    return true;
  }
...
export {
  ...
  He as INFERNO,
  qe as PLASMA,
  Ve as POINT_ATTRIBUTES,
  We as POINT_ATTRIBUTE_TYPES,
  Ke as PointAttributeName,
  Je as PointAttributes,
  Ze as PointCloudMaterial,
  et as PointCloudOctree,
  tt as PointCloudOctreeGeometry,
  nt as PointCloudOctreeGeometryNode,
  it as PointCloudOctreeNode,
  rt as PointCloudOctreePicker,
  ot as PointCloudTree,
  at as PointColorType,
  st as PointOpacityType,
  lt as PointShape,
  ct as PointSizeType,
  dt as Potree,
  ht as QueueItem,
  ...
  gt as Version,
  Pt as YELLOW_GREEN,
  bt as generateClassificationTexture,
  vt as generateDataTexture,
  yt as generateGradientTexture
};
//# sourceMappingURL=potree-core.js.map
